        ...
        <div data-aos="fade-right" className='flex justify-center mt-4 h-[500px]'>
            <div className="card w-80 bg-sky-400 shadow-xl ">
                <figure class=" overflow-hidden rounded-md">
                    <img src={p2} alt="" class="w-full transition-transform duration-[3000ms] hover:-translate-y-[35%]" />
                </figure>
                <div className="card-body">
                    ...
                    <div className="flex gap-2">
                        <div><a href="https://github.com/anik12136/You-Drawing-client"><button className="btn btn-default btn-outline">github Client</button></a></div>
                        <div> <a href="https://github.com/anik12136/You-drawing-server"><button className="btn btn-default btn-outline">github Server</button></a></div>
                        <div><a href="https://fir-assignment-10-d2367.web.app/"><button className="btn btn-default btn-outline">Live Link</button></a></div>
                    </div>
                </div>
            </div>
        </div>
