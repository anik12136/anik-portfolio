...
----------------------------------------------------------------------- */
    ...
    const fetchData = async () => {
      try {
        /* ------------------------
          ...
          --------------------------------- */
        const response = await fetch("https://ul-earning-server.vercel.app/communityPost");
        if (!response.ok) {
    ...
    const fetchData = async () => {
      try {
        const response = await fetch(
          "https://ul-earning-server.vercel.app/communityPost"
  ...
  return (
    <div>
      {
        fetchData?.map((post)=><Post post={post} key={post._id}></Post>)
      }
