  ...
  return (
    <div>
      <div className=" py-20 flex justify-center items-center">
        <div className="p-8 bg-slate-50 rounded-md w-[600px]">
          <form onSubmit={handleSubmit(onSubmit)}>
           ...
           {/*  <div>
            ...
            <button
              className="mt-6 px-10 py-4 w-full rounded-full   text-black bg-yellow-400 flex justify-center items-center gap-3 hover:text-yellow-500 hover:bg-black"
              type="submit"
              value="Post"
            >
              Update
