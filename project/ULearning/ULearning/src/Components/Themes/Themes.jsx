...
const Dropdown = () => {
  ...
  return (
    <div>
      <div>
        <div
          className=" hover:text-yellow-400  dark:hover:bg-[#0e3041] hover:cursor-pointer p-3 rounded-xl flex justify-center items-center"
          onClick={themeButton}
        >
        ...
        <div className="relative">
          ...
          >
            ...
            <li
              ...
              className="mb-2 cursor-pointer bg-[#617d6b] hover:bg-yellow-500 dark:bg-[#0e3041] dark:text-white dark:hover:bg-[#132027] px-2 py-2 rounded-md flex justify-between items-center"
            >
            ...
            <li
              ...
              className="cursor-pointer bg-[#617d6b] hover:bg-yellow-500 dark:bg-[#0e3041] dark:text-white dark:hover:bg-[#132027] px-2 py-2 rounded-md flex gap-10 justify-between items-center"
            >
