...
const AddTOCart = ({ course }) => {
  ...
  const handleAddToCart = course => {
    ...
    if (user && user.email) {
      ...
      fetch('https://ul-earning-server.vercel.app/carts', {
        method: 'POST',
        headers: {
  ...
  return (
    ...
    <button onClick={() => handleAddToCart(course)} className=" text-black
    ">
   
      <ShoppingCartIcon className="h-6 ml-4 hover: "></ShoppingCartIcon>
